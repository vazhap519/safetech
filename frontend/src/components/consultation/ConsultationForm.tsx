...
export default function ConsultationForm({
    ...
    const addressLabel = t("consultation.form.address", {
    ...
    const requiredHint = t("consultation.form.requiredHint", {
    ...
    const submitLabel = t("consultation.form.submit", {
        ka: "კონსულტაციის მიღება",
        en: "Get consultation",
        ru: "Получить консультацию",
    });
    const privacyLabel = t("forms.privacy", {
        ka: "ვეთანხმები ჩემი საკონტაქტო მონაცემების გამოყენებას კონსულტაციასთან დაკავშირებით.",
