...
return new class extends Migration
{
    ...
    private function location(
        ...
        // Georgian locative endings are irregular: ქალაქი + "-ში" is not a valid template.
        $locativeCity = [
            'tbilisi' => 'თბილისში',
            'khashuri' => 'ხაშურში',
        ...
        $faq = [
            ['question' => "რა ღირს კამერების მონტაჟი {$locativeCity}?", 'answer' => 'საბოლოო ფასი დამოკიდებულია კამერების რაოდენობაზე, ტიპზე, NVR/DVR-ზე, HDD-ზე, კაბელის სიგრძეზე, UPS-ზე და მონტაჟის სირთულეზე. ზუსტი შეთავაზებისთვის საჭიროა ობიექტის მოთხოვნების შეფასება.'],
