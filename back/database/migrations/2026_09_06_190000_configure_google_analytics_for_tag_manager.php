...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // The frontend already loads GTM/GA through the consent-aware marketing
        // integration. Enable it when no administrator choice exists yet.
    ...
    {
        // Preserve administrator-managed analytics settings during rollbacks.
    }
