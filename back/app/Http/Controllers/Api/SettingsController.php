    ...
    public function index(): JsonResponse
    {
        ...
        return response()->json([
            ...
            'contact_page' => [
                ...
                'whatsapp_message_en' => $contact['whatsapp_message_en'] ?? null,
                'whatsapp_message_ru' => $contact['whatsapp_message_ru'] ?? null,
                'viber' => null,
                'email' => $contact['email'] ?? null,
                'address' => $contact['address'] ?? null,
                'address_en' => $contact['address_en'] ?? null,
                'address_ru' => $contact['address_ru'] ?? null,
                'hours' => $contact['hours'] ?? null,
                'hours_en' => $contact['hours_en'] ?? null,
                'hours_ru' => $contact['hours_ru'] ?? null,
                'hero_title' => null,
                'hero_text' => null,
                'why_title' => null,
                'why_items' => [],
