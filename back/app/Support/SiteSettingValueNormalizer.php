...
final class SiteSettingValueNormalizer
{
    ...
    public static function normalizeContact(array $value): array
    {
        ...
        return array_merge($value, [
            ...
            'address_en' => self::trimmedString($value['address_en'] ?? ''),
            'address_ru' => self::trimmedString($value['address_ru'] ?? ''),
            ...
            'whatsapp_message_en' => self::stringValue($value['whatsapp_message_en'] ?? ''),
            'whatsapp_message_ru' => self::stringValue($value['whatsapp_message_ru'] ?? ''),
            'hours' => self::stringValue($value['hours'] ?? ''),
            'hours_en' => self::stringValue($value['hours_en'] ?? ''),
            'hours_ru' => self::stringValue($value['hours_ru'] ?? ''),
