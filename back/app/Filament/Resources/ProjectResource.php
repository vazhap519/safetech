            ...
            Section::make('Project sections')
                ...
                ->schema([
                    ...
                    Repeater::make('related')
                        ...
                        ->helperText('AI ამ ბლოკს განზრახ არ ირჩევს: ჯერ მონიშნეთ რეალურად დაკავშირებული Project, შემდეგ სათაური, კატეგორია და image alt არჩეული ჩანაწერიდან ავტომატურად შეივსება.')
                        ->schema([
                            Select::make('slug')
                                ->label('Project')
