        ...
        <div className="grid md:grid-cols-3 gap-10 mt-20">
          ...
          {services.map((service, i) => (
            <Link key={service.slug} href={`/services/${service.slug}`}>
              ...
              <div
                className={`group relative bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-700 hover:-translate-y-3 ${
                  visible
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    ...
                    <div className="w-9 h-9 rounded-full bg-[#00C2A8]/10 flex items-center justify-center group-hover:bg-[#00C2A8] group-hover:scale-110 transition">
                ...
                {/* 🔥 GLOW BORDER */}
                <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 border border-[#00C2A8]/30 blur-[1px] transition"></div>
