...
import useFadeIn from "../../hooks/useFadeIn"; // 🔥 ეს აკლია
import CountUp from "react-countup"; // თუ უკვე არ გაქვს
          ...
          {data.map((item, i) => {
            ...
            return (
              <div
                ...
                shadow-sm hover:shadow-2xl transition-all duration-700 hover:-translate-y-2
                ${
                  visible
